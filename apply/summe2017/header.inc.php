<div class="container">
  <div class="row">
    <div class="col-sm-8 py-4">
      ...
      <hr />
      <p class="text-muted">
        Jury Programm Screenings „videoförmig“ im Neuen Kino: Dr. Kuckucks Labrador  (Sara Grütter, Chris Hunter, Lysann König, Yolanda Natsch, Natascha Nüesch, Raphael Stucky)
      </p>
      <p class="text-muted">
        Jury Ausstellung „videoförmig“ im Kasko: Team: Muda Mathis, Chris Regn,  Uri Urech, Michel Winterberg, Sus Zwick
        Projektverantwortliche: Chris Regn, info@kasko.ch
      </p>
      <p class="text-muted">
        Jury „nachtflimmern": Eva Borner, Christiane Klotz, Katharina Rüegg, Eveline Schüep
        Projektverantwortliche: Eveline Schüep, eve.sch@gmx.ch
      </p>
    </div>
