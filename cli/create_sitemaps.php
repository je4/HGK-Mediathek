...
$mapsize = 20000;
  ...
  $squery->createFilterQuery('source')->setQuery("source:zotero OR source:Wenkenpark OR catalog:HGK OR catalog:HGKplus");
  $squery->createFilterQuery('not')->setQuery("-(source:eartnet OR source:ikuvid OR source:EZB OR source:DOAJArticle)");
	$qstr = '*:*';
