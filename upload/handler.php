...
class UploadHandler {
    ...
    public $chunksFolder = '/data2/mab-basel/chunks';
    ...
    public function getName(){
        if (isset($_REQUEST['qqfilename']))
            return preg_replace( '/[^A-Za-z_0-9\-\.]/', "_", iconv("UTF-8", "ASCII//TRANSLIT", $_REQUEST['qqfilename'] ));

        if (isset($_FILES[$this->inputName]))
            return preg_replace( '/[^A-Za-z0-9_\-\.]/', "_", iconv("UTF-8", "ASCII//TRANSLIT", $_FILES[$this->inputName]['name'] ));
    }
