...
class HGKWebEntity extends SOLRSource {

    private $idprefix = 'hgkweb';
    private $db = null;
...
//            exit;
    ...
    public function getEmbedded() {
		return false; // wir haben nur verweise
	}
    ...
    public function getPublisher() {
        if( $this->data == null ) throw new \Exception( "no entity loaded" );
        return "Hochschule für Gestaltung und Kunst FHNW, Basel";
    }
   ...
   public function getContent() {
	...
	public function getCatalogs() { return array( $this->getSource(), 'websearch' ); }
