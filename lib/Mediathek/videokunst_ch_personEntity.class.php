...
class videokunst_ch_personEntity extends SOLRSource {
    ...
    public function getTitle() {
        ...
        $title = trim( $this->data['artistname'] );
	...
	public function getTags() {
        ...
        $this->tags = array('index:type/'.md5( 'cv' ).'/cv' );
    ...
    public function getURLs() {
  		$urls = array( $this->data['artistlink'] );
  		return $urls;
    }
   ...
   public function getAbstract() {
        if( $this->data == null ) throw new \Exception( "no entity loaded" );
        return strip_tags( $this->data['artisttext'] );
    }

   public function getContent() {
     if( $this->data == null ) throw new \Exception( "no entity loaded" );
     $str = '';
     if( array_key_exists( 'bio1', $this->data )) $str .= "\n".$this->data['bio1'];
     if( array_key_exists( 'bio2', $this->data )) $str .= "\n".$this->data['bio2'];
     if( array_key_exists( 'bio3', $this->data )) $str .= "\n".$this->data['bio3'];
	...
	public function getCategories() {
		...
		$categories[] = 'extarchives!!videokunst_ch!!person';
		return $categories;
	}
